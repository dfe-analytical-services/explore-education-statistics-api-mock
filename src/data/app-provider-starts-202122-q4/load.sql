...
COPY data_normalised FROM '/home/nick/Development/personal/ees-public-api-mock/src/data/app-provider-starts-202122-q4/data_normalised.parquet' (FORMAT 'parquet', CODEC 'ZSTD');
