COPY data_temp FROM '/home/nick/Development/personal/ees-public-api-mock/src/data/app-provider-starts-202122-q4/data_temp.parquet' (FORMAT 'parquet', CODEC 'ZSTD');
