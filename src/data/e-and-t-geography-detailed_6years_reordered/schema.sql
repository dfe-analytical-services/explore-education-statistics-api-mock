...
CREATE TABLE data_normalised(id UINTEGER PRIMARY KEY DEFAULT(nextval('data_seq')), time_period VARCHAR, time_identifier VARCHAR, geographic_level VARCHAR, country_id UINTEGER, region_id UINTEGER, local_authority_district_id UINTEGER, english_devolved_area_id UINTEGER, ethnicity_group UINTEGER, ssa_t1_desc UINTEGER, notional_nvq_level UINTEGER, sex UINTEGER, e_and_t_aims_ach VARCHAR, e_and_t_aims_enrolments VARCHAR);
