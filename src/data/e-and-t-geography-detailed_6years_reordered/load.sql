...
COPY data_normalised FROM '/home/nick/Development/personal/ees-public-api-mock/src/data/e-and-t-geography-detailed_6years_reordered/data_normalised.parquet' (FORMAT 'parquet', CODEC 'ZSTD');
