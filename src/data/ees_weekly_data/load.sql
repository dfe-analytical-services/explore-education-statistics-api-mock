...
COPY data_normalised FROM '/home/nick/Development/personal/ees-public-api-mock/src/data/ees_weekly_data/data_normalised.parquet' (FORMAT 'parquet', CODEC 'ZSTD');
