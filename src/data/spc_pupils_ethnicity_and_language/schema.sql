...
CREATE TABLE data_normalised(id UINTEGER PRIMARY KEY DEFAULT(nextval('data_seq')), time_period VARCHAR, time_identifier VARCHAR, geographic_level VARCHAR, "Country :: id" UINTEGER, "Country :: ordering" UINTEGER, "Region :: id" UINTEGER, "Region :: ordering" UINTEGER, "LocalAuthority :: id" UINTEGER, "LocalAuthority :: ordering" UINTEGER, "language :: id" UINTEGER, "language :: ordering" UINTEGER, "phase_type_grouping :: id" UINTEGER, "phase_type_grouping :: ordering" UINTEGER, "ethnicity :: id" UINTEGER, "ethnicity :: ordering" UINTEGER, headcount VARCHAR, percent_of_pupils VARCHAR);
