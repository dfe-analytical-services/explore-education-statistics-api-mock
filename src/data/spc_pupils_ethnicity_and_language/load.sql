COPY data_temp FROM '/home/nick/Development/personal/ees-public-api-mock/src/data/spc_pupils_ethnicity_and_language/data_temp.parquet' (FORMAT 'parquet', CODEC 'ZSTD');
