...
COPY data_normalised FROM '/home/nick/Development/personal/ees-public-api-mock/src/data/spc_pupils_ethnicity_and_language/data_normalised.parquet' (FORMAT 'parquet', CODEC 'ZSTD');
