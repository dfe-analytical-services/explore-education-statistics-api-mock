COPY data_temp FROM '/home/nick/Development/personal/ees-public-api-mock/src/data/spc_pupils_fsm_ethnicity_yrgp/data_temp.parquet' (FORMAT 'parquet', CODEC 'ZSTD');
