...
CREATE TABLE data_normalised(id UINTEGER PRIMARY KEY DEFAULT(nextval('data_seq')), time_period VARCHAR, time_identifier VARCHAR, geographic_level VARCHAR, "Country :: id" UINTEGER, "Country :: ordering" UINTEGER, "Region :: id" UINTEGER, "Region :: ordering" UINTEGER, "YAG :: id" UINTEGER, "YAG :: ordering" UINTEGER, "subject_name :: id" UINTEGER, "subject_name :: ordering" UINTEGER, "SECTIONNAME :: id" UINTEGER, "SECTIONNAME :: ordering" UINTEGER, "qualification_TR :: id" UINTEGER, "qualification_TR :: ordering" UINTEGER, difference VARCHAR, earnings_median VARCHAR, living_in_region VARCHAR, trained_in_region VARCHAR, number_of_providers VARCHAR, difference_prop VARCHAR);
