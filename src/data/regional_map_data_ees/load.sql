...
COPY data_normalised FROM '/home/nick/Development/personal/ees-public-api-mock/src/data/regional_map_data_ees/data_normalised.parquet' (FORMAT 'parquet', CODEC 'ZSTD');
